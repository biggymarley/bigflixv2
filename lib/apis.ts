...
export const MOVIES_GENRES_API = "genre/movie/list";
export const SERIES_GENRES_API = "genre/tv/list";
export const DISCOVER_MOVIES_API = "discover/movie";
export const DISCOVER_SERIES_API = "discover/tv";
